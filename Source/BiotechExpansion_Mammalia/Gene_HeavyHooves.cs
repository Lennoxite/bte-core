	...
	public class Gene_HeavyHooves : Gene
	{
		...
		public List<Hediff> LinkedHediff
		{
			get
			{
				...
				for (int i = 0; i < hediffs.Count; i++)
				{
					...
					if (hediffs[i].def == BTE_HediffDefOf.BTEMa_HeavyHooves)
					{
		...
		public override void PostAdd()
		{
			...
			foreach (BodyPartRecord hd in hands)
			{
				...
				{
					Hediff h = this.pawn.health.AddHediff(BTE_HediffDefOf.BTEMa_HeavyHooves, hd, null, null);
		...
		public override void PostRemove()
		{
			...
			//				this.pawn.health.AddHediff(BTE_HediffDefOf.BTE_Ma_heavyHooves, hd, null, null);
			//			}
			//		}
